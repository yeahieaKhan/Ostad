...
// 1. _constructor method that takes the _construct: a id, name, and price as parameters and initializes the corresponding properties of the object.
...
$product = new Product(1,"T-shirt" , 19.45);
